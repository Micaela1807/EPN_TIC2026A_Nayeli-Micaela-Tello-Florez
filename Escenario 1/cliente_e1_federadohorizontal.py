# ============================================================
# CLIENTE - ESCENARIO 1
# Nombre del script: cliente_e1_federadohorizontal.py
...
#
# Descripción:
# Este script implementa un cliente federado para un escenario de aprendizaje federado horizontal.
# ============================================================
...
# Identificador del cliente en el experimento federado.
# Cambiar este valor si se dispone de múltiples clientes y se requiere distinguirlos.
CLIENT_ID = "1"  #Cambiar a "2" en la máquina del segundo cliente

# Dirección del servidor Flower que coordina las rondas federadas.
SERVER_IP = "10.0.2.2:8080"

# Ruta local donde se encuentra el conjunto de datos de este cliente.
DATASET_PATH = "./Dataset_cliente1"  # Cambiar a "./Dataset_cliente2" en la máquina del segundo cliente
...
# Cargar datos de entrenamiento desde el dataset
...
# Cargar datos de validación desde el dataset 
...
# Usar el autotuning de TensorFlow para optimizar la lectura de datos
...
def preprocess(x, y):
    """Normaliza cada lote de imágenes y devuelve las etiquetas sin cambios.

    Args:
        x: Lote de imágenes en formato Tensor.
        y: Etiquetas asociadas a las imágenes.
...
# ==========================
# SECCIÓN: CLIENTE FLOWER PARA APRENDIZAJE FEDERADO
# ==========================
class PlacasClient(fl.client.NumPyClient):
    ...
    def evaluate(self, parameters, config):
        """Evalúa el modelo local con los parámetros globales recibidos.

        Args:
            parameters: Pesos del modelo recibidos del servidor.
            config: Configuración de la ronda de evaluación.

        Returns:
            tuple: (pérdida, número de ejemplos de validación, métricas de evaluación)
        """
        model.set_weights(parameters)
...
if __name__ == "__main__":
    ...
    # Iniciar el cliente de Flower y conectarlo con el servidor de fl
